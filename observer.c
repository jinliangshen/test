...
void observation(){
    ...
    ob.tajima.omega_syn  = (uTs_cmd - ob.rs*iTs) / (ob.Lmu * rotor_flux_cmd / ob.Lr + ob.Lsigma*iMs);

    ob.tajima.e_M        = (uMs_cmd - ob.rs*iMs + ob.tajima.omega_syn*ob.Lsigma*iTs) * ob.Lr / ob.Lmu;
